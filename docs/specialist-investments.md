...
Stubble grazing: +1 Meat across free seasons immediately after a grain harvest at II, +2 at IV. A standing main crop or secondary rotation takes priority; snow-country winters are excluded. Best paddock works apply.

Branches: Harvest recovery, Clean threshing floors, Ventilated maize cribs.

### rotation-support

Nursery support: +1 secondary food at II, +2 at IV, shared across an active owned rotation’s harvests. Requires a free rotation season and its water/drainage works. Best nursery support applies.

Branches: Seed selection, Potato seed stores.

### forest-food

Woodland food: 1/2/3/4 Grain in autumn, representing mushrooms. Dry or cold spells halve this harvest, rounded down. Timber and visiting wildlife keep their own harvests.

Branches: Woodland food gardens.

### resin

Resin collection: 1/2/3/4 Oil in summer. A wet or cold spell removes one Oil from that harvest. Requires conifer woodland in a cold or Alpine climate.

Branches: Conifer resin yards.

### shellfish

Settled shellfish: 1/2/3/4 Fish shared across the four seasons, even when shoals have migrated away. Matching rolls are required. Ice, flooding and enemy blockades still prevent collection.

Branches: Coastal shellfish beds.

### fish-nursery

Fish refuge: visiting fish are 20/40/60/80% more likely to choose this habitat, before other migration factors. Shoals remain mobile; only the strongest nursery applies.

Branches: Reed spawning refuges, Reef catch landings.

### habitat-margins

Shelter margins: reduce development disturbance in adjacent wild habitat by 10/20/30/40%. A stronger local refuge takes priority. Animals still choose among suitable habitats.

Branches: Field windbreaks, Contour planting strips, Orchard mulch beds.

### material-reuse

Local material yard: reduces eligible Wood or Stone costs of later works on this tile by 10/20/30/40%, rounded down, saving at most 1/2/3/4 of each material per bill. Coal and manufactured goods retain their full cost. Material yards do not discount each other.

Branches: Log sorting, Stone dressing, Extraction loading bays.
...
- Additional working practice: rotation-support.
- Products: grain.
- Effect: +1 shared annual-profile card per purchased stage.
...
- Main track: Forestry infrastructure.
- Additional site filter: `forest` (in addition to the main track’s resource and climate eligibility).
- Terrains: Forest, Old-growth forest, Woods.
- Climates: Cold, Alpine.
- Additional working practice: resin.
- Additional fittings per stage number: 2 ceramics.
- Products: oil.
- Effect: +1 shared annual-profile card per purchased stage.

1. **Resin cups** — adjacent settlement/city tier 1.
2. **Managed tapping rounds** — adjacent settlement/city tier 2.
3. **Resin collection pumps** — adjacent settlement/city tier 3.
4. **Integrated resin yard** — adjacent settlement/city tier 4.

### Woodland food gardens

Shaded beds of fallen wood and leaf litter support an autumn mushroom harvest beneath the trees.

- Main track: Forestry infrastructure.
- Additional site filter: `forest` (in addition to the main track’s resource and climate eligibility).
- Climates: Temperate, Oceanic, Temperate Rainforest, Cold, Alpine.
- Additional working practice: forest-food.
- Additional fittings per stage number: 2 lumber, 1 ceramics.
- Products: grain.
- Effect: +1 shared annual-profile card per purchased stage.

1. **Shaded mushroom beds** — adjacent settlement/city tier 1.
2. **Managed woodland beds** — adjacent settlement/city tier 2.
3. **Spawn nursery** — adjacent settlement/city tier 3.
4. **Forest food nursery** — adjacent settlement/city tier 4.
...
- Main track: Fishery infrastructure.
- Additional site filter: `any` (in addition to the main track’s resource and climate eligibility).
- Climates: Temperate, Oceanic, Temperate Rainforest, Mediterranean, Subtropical, Tropical, Tropical Maritime, Monsoon, Mesoamerican.
- Additional working practice: shellfish.
- Coastal site.
- Additional fittings per stage number: 2 lumber, 1 wool.
- Products: fish.
- Effect: +1 shared annual-profile card per purchased stage.

1. **Shellfish stakes** — adjacent settlement/city tier 1.
2. **Basket beds** — adjacent settlement/city tier 2.
3. **Suspended culture ropes** — adjacent settlement/city tier 3.
4. **Managed shellfish park** — adjacent settlement/city tier 4.

### Reed spawning refuges

Protected reed margins and quiet coves offer shelter for visiting fish along the freshwater shore.

- Main track: Fishery infrastructure.
- Additional site filter: `any` (in addition to the main track’s resource and climate eligibility).
- Additional working practice: fish-nursery.
- Additional fittings per stage number: 1 lumber, 1 stone.
- Products: fish.
- Effect: +1 shared annual-profile card per purchased stage.

1. **Protected reed margin** — adjacent settlement/city tier 1.
2. **Quiet spawning coves** — adjacent settlement/city tier 2.
3. **Managed reed nursery** — adjacent settlement/city tier 3.
4. **Connected spawning refuges** — adjacent settlement/city tier 4.
...
- Main track: Soil husbandry.
- Additional site filter: `cereal` (in addition to the main track’s resource and climate eligibility).
- Additional working practice: rotation-support.
- Products: grain.
- Effect: +1 shared annual-profile card per purchased stage.

1. **Seed sieves** — adjacent settlement/city tier 1.
2. **Selection benches** — adjacent settlement/city tier 2.
3. **Mechanical seed grader** — adjacent settlement/city tier 3.
4. **Seed testing house** — adjacent settlement/city tier 4.
...
- Main track: Soil husbandry.
- Additional site filter: `cereal` (in addition to the main track’s resource and climate eligibility).
- Additional working practice: stubble-grazing.
- Products: grain.
- Effect: +1 shared annual-profile card per purchased stage.

1. **Gleaning baskets** — adjacent settlement/city tier 1.
2. **Harvest collection yard** — adjacent settlement/city tier 2.
3. **Sheaf handling machinery** — adjacent settlement/city tier 3.
4. **Grain recovery works** — adjacent settlement/city tier 4.
...
- Main track: Soil husbandry.
- Additional site filter: `dry-crop` (in addition to the main track’s resource and climate eligibility).
- Additional working practice: habitat-margins.
- Products: grain, oil.
- Effect: 10% of remaining dry-spell losses removed per stage.

1. **Brush wind screens** — adjacent settlement/city tier 1.
2. **Shelter hedges** — adjacent settlement/city tier 2.
3. **Managed shelter strips** — adjacent settlement/city tier 3.
4. **Shelterbelt nursery** — adjacent settlement/city tier 4.
...
- Main track: Soil husbandry.
- Additional site filter: `wet-cereal` (in addition to the main track’s resource and climate eligibility).
- Products: grain.
- Effect: 10% of remaining wet-spell losses removed per stage.

1. **Raised drying mats** — adjacent settlement/city tier 1.
2. **Ventilated grain shed** — adjacent settlement/city tier 2.
3. **Heated grain dryer** — adjacent settlement/city tier 3.
4. **Controlled drying house** — adjacent settlement/city tier 4.
...
1. **Covered root clamps** — adjacent settlement/city tier 1.
2. **Ventilated root cellar** — adjacent settlement/city tier 2.
3. **Root washing equipment** — adjacent settlement/city tier 3.
4. **Insulated root store** — adjacent settlement/city tier 4.
...
1. **Reed nursery screens** — adjacent settlement/city tier 1.
2. **Sheltered nursery beds** — adjacent settlement/city tier 2.
3. **Glazed propagation house** — adjacent settlement/city tier 3.
4. **Heated nursery benches** — adjacent settlement/city tier 4.
...
1. **Padded picking baskets** — adjacent settlement/city tier 1.
2. **Orchard grading tables** — adjacent settlement/city tier 2.
3. **Fruit handling lift** — adjacent settlement/city tier 3.
4. **Orchard packing house** — adjacent settlement/city tier 4.
...
1. **Settling jars** — adjacent settlement/city tier 1.
2. **Separate pressing benches** — adjacent settlement/city tier 2.
3. **Filter press** — adjacent settlement/city tier 3.
4. **Oil clarification works** — adjacent settlement/city tier 4.
...
1. **Rice threshing frames** — adjacent settlement/city tier 1.
2. **Paddy winnowing yard** — adjacent settlement/city tier 2.
3. **Paddy thresher** — adjacent settlement/city tier 3.
4. **Rice grading mill** — adjacent settlement/city tier 4.

### Ventilated maize cribs

Open-sided cribs dry harvested cobs before shelling, preserving more sound kernels.

- Main track: Soil husbandry.
- Additional site filter: `maize` (in addition to the main track’s resource and climate eligibility).
- Additional working practice: stubble-grazing.
- Products: grain.
- Effect: +1 shared annual-profile card per purchased stage.

1. **Raised cob racks** — adjacent settlement/city tier 1.
2. **Slatted maize crib** — adjacent settlement/city tier 2.
3. **Mechanical corn sheller** — adjacent settlement/city tier 3.
4. **Ventilated maize store** — adjacent settlement/city tier 4.

### Clean threshing floors
...
1. **Beaten threshing floor** — adjacent settlement/city tier 1.
2. **Paved threshing yard** — adjacent settlement/city tier 2.
3. **Rotary grain cleaner** — adjacent settlement/city tier 3.
4. **Enclosed threshing hall** — adjacent settlement/city tier 4.
...
1. **Cistern shade mats** — adjacent settlement/city tier 1.
2. **Masonry cistern roofs** — adjacent settlement/city tier 2.
3. **Sealed intake fittings** — adjacent settlement/city tier 3.
4. **Cistern monitoring house** — adjacent settlement/city tier 4.
...
1. **Settling pockets** — adjacent settlement/city tier 1.
2. **Silt removal bays** — adjacent settlement/city tier 2.
3. **Mechanical channel scraper** — adjacent settlement/city tier 3.
4. **Sediment control works** — adjacent settlement/city tier 4.
...
1. **Clay channel seals** — adjacent settlement/city tier 1.
2. **Lined feeder joints** — adjacent settlement/city tier 2.
3. **Pressure-tested conduits** — adjacent settlement/city tier 3.
4. **Water-loss control house** — adjacent settlement/city tier 4.
...
1. **Return-water furrows** — adjacent settlement/city tier 1.
2. **Recovery sluices** — adjacent settlement/city tier 2.
3. **Paddy return pump** — adjacent settlement/city tier 3.
4. **Balanced recovery network** — adjacent settlement/city tier 4.

### Contour planting strips

Closely spaced contour strips retain productive soil on cultivated slopes.

- Main track: Agricultural terraces.
- Additional site filter: `any` (in addition to the main track’s resource and climate eligibility).
- Additional working practice: habitat-margins.
- Products: grain, oil.
- Effect: +1 shared annual-profile card per purchased stage.

1. **Contour planting lines** — adjacent settlement/city tier 1.
2. **Stone-faced field strips** — adjacent settlement/city tier 2.
3. **Contour surveying station** — adjacent settlement/city tier 3.
4. **Managed hillside strips** — adjacent settlement/city tier 4.
...
1. **Outlet ditches** — adjacent settlement/city tier 1.
2. **Grated field outlets** — adjacent settlement/city tier 2.
3. **Outfall lifting gear** — adjacent settlement/city tier 3.
4. **Controlled drainage outfalls** — adjacent settlement/city tier 4.
...
1. **Hand-shaped ridges** — adjacent settlement/city tier 1.
2. **Permanent raised rows** — adjacent settlement/city tier 2.
3. **Mechanical ridge former** — adjacent settlement/city tier 3.
4. **Managed ridge drainage** — adjacent settlement/city tier 4.

### Stubble snow capture

Standing stubble catches winter snow, storing moisture for the following growing season.

- Main track: Soil husbandry.
- Additional site filter: `continental-cereal` (in addition to the main track’s resource and climate eligibility).
- Products: grain.
- Effect: 10% of remaining dry-spell losses removed per stage.

1. **Tall stubble strips** — adjacent settlement/city tier 1.
2. **Snow-catching field fences** — adjacent settlement/city tier 2.
3. **Stubble management equipment** — adjacent settlement/city tier 3.
4. **Snow-water field network** — adjacent settlement/city tier 4.
...
- Main track: Soil husbandry.
- Additional site filter: `thirsty-orchard` (in addition to the main track’s resource and climate eligibility).
- Additional working practice: habitat-margins.
- Products: grain.
- Effect: 10% of remaining dry-spell losses removed per stage.

1. **Leaf mulch beds** — adjacent settlement/city tier 1.
2. **Compost spreading yard** — adjacent settlement/city tier 2.
3. **Mulch chopper** — adjacent settlement/city tier 3.
4. **Orchard soil-cover works** — adjacent settlement/city tier 4.
...
1. **Covered hay stacks** — adjacent settlement/city tier 1.
2. **Fodder barn** — adjacent settlement/city tier 2.
3. **Fodder baling press** — adjacent settlement/city tier 3.
4. **Ventilated fodder depot** — adjacent settlement/city tier 4.
...
1. **Sheltered birthing pens** — adjacent settlement/city tier 1.
2. **Insulated livestock shed** — adjacent settlement/city tier 2.
3. **Warm bedding workshop** — adjacent settlement/city tier 3.
4. **Veterinary shelter house** — adjacent settlement/city tier 4.
...
1. **Clean shearing mats** — adjacent settlement/city tier 1.
2. **Fleece sorting tables** — adjacent settlement/city tier 2.
3. **Wool baling press** — adjacent settlement/city tier 3.
4. **Fleece grading house** — adjacent settlement/city tier 4.
...
1. **Stock guiding lanes** — adjacent settlement/city tier 1.
2. **Handling yards** — adjacent settlement/city tier 2.
3. **Livestock weighing equipment** — adjacent settlement/city tier 3.
4. **Coordinated stock depot** — adjacent settlement/city tier 4.
...
1. **Reed shade shelters** — adjacent settlement/city tier 1.
2. **Permanent shade yards** — adjacent settlement/city tier 2.
3. **Ventilated stock sheds** — adjacent settlement/city tier 3.
4. **Sheltered grazing station** — adjacent settlement/city tier 4.
...
1. **Temporary grazing fences** — adjacent settlement/city tier 1.
2. **Rotational paddocks** — adjacent settlement/city tier 2.
3. **Pasture mowing equipment** — adjacent settlement/city tier 3.
4. **Managed grazing estate** — adjacent settlement/city tier 4.

### Upland wind shelters
...
1. **Stone wind corners** — adjacent settlement/city tier 1.
2. **Highland stock shelters** — adjacent settlement/city tier 2.
3. **Insulated upland barns** — adjacent settlement/city tier 3.
4. **Mountain husbandry station** — adjacent settlement/city tier 4.
...
1. **Hide stretching frames** — adjacent settlement/city tier 1.
2. **Salted hide shed** — adjacent settlement/city tier 2.
3. **Hide handling machinery** — adjacent settlement/city tier 3.
4. **Controlled hide curing house** — adjacent settlement/city tier 4.
...
- Main track: Forestry infrastructure.
- Additional site filter: `any` (in addition to the main track’s resource and climate eligibility).
- Additional working practice: material-reuse.
- Products: lumber.
- Effect: +1 shared annual-profile card per purchased stage.

1. **Log grading marks** — adjacent settlement/city tier 1.
2. **Timber sorting yard** — adjacent settlement/city tier 2.
3. **Log sorting crane** — adjacent settlement/city tier 3.
4. **Timber grading depot** — adjacent settlement/city tier 4.

### Covered timber yards
...
1. **Covered timber stacks** — adjacent settlement/city tier 1.
2. **Drained timber shed** — adjacent settlement/city tier 2.
3. **Ventilated drying kiln** — adjacent settlement/city tier 3.
4. **Seasoning warehouse** — adjacent settlement/city tier 4.

### Winter logging shelters
...
1. **Winter tool shelter** — adjacent settlement/city tier 1.
2. **Covered logging depot** — adjacent settlement/city tier 2.
3. **Warmed repair shop** — adjacent settlement/city tier 3.
4. **Cold-weather forestry station** — adjacent settlement/city tier 4.
...
1. **Sharpening benches** — adjacent settlement/city tier 1.
2. **Forest repair forge** — adjacent settlement/city tier 2.
3. **Mechanical saw sharpener** — adjacent settlement/city tier 3.
4. **Toolmaking workshop** — adjacent settlement/city tier 4.

### Hillside timber landings
...
1. **Hillside loading platforms** — adjacent settlement/city tier 1.
2. **Timber cable anchors** — adjacent settlement/city tier 2.
3. **Powered loading winch** — adjacent settlement/city tier 3.
4. **Coordinated cable landings** — adjacent settlement/city tier 4.

### Wetland timber access
...
1. **Raised logging walks** — adjacent settlement/city tier 1.
2. **Timber extraction platforms** — adjacent settlement/city tier 2.
3. **Wetland loading derrick** — adjacent settlement/city tier 3.
4. **Raised forestry depot** — adjacent settlement/city tier 4.
...
1. **Ore picking tables** — adjacent settlement/city tier 1.
2. **Ore grading floor** — adjacent settlement/city tier 2.
3. **Mechanical sorting screen** — adjacent settlement/city tier 3.
4. **Ore preparation house** — adjacent settlement/city tier 4.

### Mine runoff diversion
...
1. **Cutoff drains** — adjacent settlement/city tier 1.
2. **Mine entrance culverts** — adjacent settlement/city tier 2.
3. **Runoff clearing equipment** — adjacent settlement/city tier 3.
4. **Managed mine drainage perimeter** — adjacent settlement/city tier 4.

### Cold-weather mine shelters
...
1. **Covered mine entrance** — adjacent settlement/city tier 1.
2. **Sheltered haulage shed** — adjacent settlement/city tier 2.
3. **Heated repair house** — adjacent settlement/city tier 3.
4. **Winter mine service depot** — adjacent settlement/city tier 4.
...
1. **Vein survey marks** — adjacent settlement/city tier 1.
2. **Mine assay benches** — adjacent settlement/city tier 2.
3. **Core sampling workshop** — adjacent settlement/city tier 3.
4. **Geological survey office** — adjacent settlement/city tier 4.
...
1. **Coal picking floor** — adjacent settlement/city tier 1.
2. **Coal screening shed** — adjacent settlement/city tier 2.
3. **Powered coal screens** — adjacent settlement/city tier 3.
4. **Coal preparation plant** — adjacent settlement/city tier 4.
...
1. **Fine sorting trays** — adjacent settlement/city tier 1.
2. **Gravity separation tables** — adjacent settlement/city tier 2.
3. **Ore crushing mill** — adjacent settlement/city tier 3.
4. **Fine recovery works** — adjacent settlement/city tier 4.
...
1. **Loading chutes** — adjacent settlement/city tier 1.
2. **Measured wagon bays** — adjacent settlement/city tier 2.
3. **Mechanical wagon tippler** — adjacent settlement/city tier 3.
4. **Mine dispatch works** — adjacent settlement/city tier 4.
...
- Main track: Mining infrastructure.
- Additional site filter: `lowland` (in addition to the main track’s resource and climate eligibility).
- Products: ore, coal, gold.
- Effect: 10% of remaining wet-spell losses removed per stage.

1. **Sediment sumps** — adjacent settlement/city tier 1.
2. **Lined settling basins** — adjacent settlement/city tier 2.
3. **Sump clearing machinery** — adjacent settlement/city tier 3.
4. **Mine-water settling works** — adjacent settlement/city tier 4.
...
1. **Stone loading ramps** — adjacent settlement/city tier 1.
2. **Cable loading platforms** — adjacent settlement/city tier 2.
3. **Ore lifting winch** — adjacent settlement/city tier 3.
4. **Mountain ore transfer house** — adjacent settlement/city tier 4.
...
1. **Stone dressing benches** — adjacent settlement/city tier 1.
2. **Splitting yard** — adjacent settlement/city tier 2.
3. **Powered stone cutter** — adjacent settlement/city tier 3.
4. **Stone finishing works** — adjacent settlement/city tier 4.
...
- Main track: Quarry infrastructure.
- Additional site filter: `any` (in addition to the main track’s resource and climate eligibility).
- Products: stone, brick, coal.
- Effect: 10% of remaining wet-spell losses removed per stage.

1. **Quarry sumps** — adjacent settlement/city tier 1.
2. **Perimeter drains** — adjacent settlement/city tier 2.
3. **Sump lifting pump** — adjacent settlement/city tier 3.
4. **Managed quarry drainage** — adjacent settlement/city tier 4.
...
1. **Clay picking beds** — adjacent settlement/city tier 1.
2. **Clay settling tanks** — adjacent settlement/city tier 2.
3. **Clay screening machine** — adjacent settlement/city tier 3.
4. **Clay preparation yard** — adjacent settlement/city tier 4.

### Quarry work shelters
...
1. **Tool and work shelters** — adjacent settlement/city tier 1.
2. **Covered quarry benches** — adjacent settlement/city tier 2.
3. **Heated maintenance house** — adjacent settlement/city tier 3.
4. **Winter quarry depot** — adjacent settlement/city tier 4.
...
1. **Peat drying racks** — adjacent settlement/city tier 1.
2. **Ventilated peat shed** — adjacent settlement/city tier 2.
3. **Peat stacking machinery** — adjacent settlement/city tier 3.
4. **Peat conditioning store** — adjacent settlement/city tier 4.

### Extraction loading bays
...
1. **Loading planks** — adjacent settlement/city tier 1.
2. **Masonry loading bays** — adjacent settlement/city tier 2.
3. **Quarry loading crane** — adjacent settlement/city tier 3.
4. **Extraction dispatch yard** — adjacent settlement/city tier 4.

### Salt storage shelters
...
1. **Covered salt stacks** — adjacent settlement/city tier 1.
2. **Sealed salt shed** — adjacent settlement/city tier 2.
3. **Ventilated salt warehouse** — adjacent settlement/city tier 3.
4. **Dry salt storage works** — adjacent settlement/city tier 4.
...
1. **Salt raking screens** — adjacent settlement/city tier 1.
2. **Crystal grading tables** — adjacent settlement/city tier 2.
3. **Mechanical salt sieve** — adjacent settlement/city tier 3.
4. **Salt grading house** — adjacent settlement/city tier 4.
...
1. **Brine settling jars** — adjacent settlement/city tier 1.
2. **Lined settling ponds** — adjacent settlement/city tier 2.
3. **Brine transfer machinery** — adjacent settlement/city tier 3.
4. **Clarified brine works** — adjacent settlement/city tier 4.
...
1. **Pan wind screens** — adjacent settlement/city tier 1.
2. **Covered finishing pans** — adjacent settlement/city tier 2.
3. **Heated pan enclosure** — adjacent settlement/city tier 3.
4. **Controlled finishing house** — adjacent settlement/city tier 4.

### Shaded fish handling
...
1. **Reed landing shade** — adjacent settlement/city tier 1.
2. **Covered sorting tables** — adjacent settlement/city tier 2.
3. **Ventilated landing shed** — adjacent settlement/city tier 3.
4. **Chilled packing house** — adjacent settlement/city tier 4.

### Catch handling crates
...
1. **Woven catch baskets** — adjacent settlement/city tier 1.
2. **Drained fish crates** — adjacent settlement/city tier 2.
3. **Crate washing equipment** — adjacent settlement/city tier 3.
4. **Insulated crate depot** — adjacent settlement/city tier 4.
...
1. **River net frames** — adjacent settlement/city tier 1.
2. **Net repair benches** — adjacent settlement/city tier 2.
3. **Net winding machinery** — adjacent settlement/city tier 3.
4. **River gear workshop** — adjacent settlement/city tier 4.
...
- Main track: Fishery infrastructure.
- Additional site filter: `reef` (in addition to the main track’s resource and climate eligibility).
- Additional working practice: fish-nursery.
- Products: fish.
- Effect: +1 shared annual-profile card per purchased stage.

1. **Reef landing racks** — adjacent settlement/city tier 1.
2. **Sheltered catch stages** — adjacent settlement/city tier 2.
3. **Small landing hoist** — adjacent settlement/city tier 3.
4. **Reef catch depot** — adjacent settlement/city tier 4.

### Lake landing stations
...
1. **Lakeside landing boards** — adjacent settlement/city tier 1.
2. **Lake sorting shelter** — adjacent settlement/city tier 2.
3. **Landing lift** — adjacent settlement/city tier 3.
4. **Lake fish handling house** — adjacent settlement/city tier 4.

### Game curing shelters
...
1. **Game hanging rails** — adjacent settlement/city tier 1.
2. **Game curing shed** — adjacent settlement/city tier 2.
3. **Chilled game room** — adjacent settlement/city tier 3.
4. **Game preservation house** — adjacent settlement/city tier 4.

### Wild hide preparation
...
1. **Hide scraping benches** — adjacent settlement/city tier 1.
2. **Wild hide drying frames** — adjacent settlement/city tier 2.
3. **Hide handling press** — adjacent settlement/city tier 3.
4. **Wild hide preparation house** — adjacent settlement/city tier 4.

### Woodland tracking posts
...
1. **Trail markers** — adjacent settlement/city tier 1.
2. **Woodland tracking shelters** — adjacent settlement/city tier 2.
3. **Hunter supply workshop** — adjacent settlement/city tier 3.
4. **Woodland game station** — adjacent settlement/city tier 4.
...
1. **Low scouting shelters** — adjacent settlement/city tier 1.
2. **Range observation posts** — adjacent settlement/city tier 2.
3. **Field supply depot** — adjacent settlement/city tier 3.
4. **Open-range hunting station** — adjacent settlement/city tier 4.

### Seal landing shelters

Sheltered coastal working areas preserve meat, hides and oil from the seal hunt.

- Main track: Hunting infrastructure.
- Additional site filter: `seal` (in addition to the main track’s resource and climate eligibility).
- Products: meat, hides, oil.
- Effect: +1 shared annual-profile card per purchased stage.

1. **Seal handling mats** — adjacent settlement/city tier 1.
2. **Coastal curing shelter** — adjacent settlement/city tier 2.
3. **Coastal product hoist** — adjacent settlement/city tier 3.
4. **Seal-product storehouse** — adjacent settlement/city tier 4.

### Berry sorting shelters
...
1. **Berry picking trays** — adjacent settlement/city tier 1.
2. **Berry sorting benches** — adjacent settlement/city tier 2.
3. **Gentle grading equipment** — adjacent settlement/city tier 3.
4. **Berry packing house** — adjacent settlement/city tier 4.
...
1. **Covered collection baskets** — adjacent settlement/city tier 1.
2. **Heath harvest shelters** — adjacent settlement/city tier 2.
3. **Ventilated collection shed** — adjacent settlement/city tier 3.
4. **Dry berry receiving house** — adjacent settlement/city tier 4.
...
1. **Oil settling barrels** — adjacent settlement/city tier 1.
2. **Whale-oil settling tanks** — adjacent settlement/city tier 2.
3. **Oil transfer pumps** — adjacent settlement/city tier 3.
4. **Whale-oil clarification house** — adjacent settlement/city tier 4.
...
1. **Shore stretching beds** — adjacent settlement/city tier 1.
2. **Hide handling slips** — adjacent settlement/city tier 2.
3. **Heavy hide hoist** — adjacent settlement/city tier 3.
4. **Whale hide preparation yard** — adjacent settlement/city tier 4.
...
- Crops: Golden fields, Barley fields, Alluvial wheat, Black-soil wheat.
- Climates: Temperate, Oceanic, Mediterranean.
- Secondary season: autumn, only when the main crop leaves it free.
- Requirements: ordinary city and suitable-site requirements.
- Stages: Stubble turnip rotation: trial plots → Stubble turnip rotation: seed nursery → Stubble turnip rotation: sowing equipment → Stubble turnip rotation: rotation station.
...
- Crops: Golden fields, Barley fields, Oat fields, Alluvial wheat.
- Climates: Oceanic, Temperate Rainforest.
- Secondary season: spring, only when the main crop leaves it free.
- Requirements: owned drainage on wet/floodplain ground.
- Stages: Atlantic overwintered beans: trial plots → Atlantic overwintered beans: seed nursery → Atlantic overwintered beans: sowing equipment → Atlantic overwintered beans: rotation station.
...
- Crops: Golden fields, Barley fields, Black-soil wheat.
- Climates: Steppe, Prairie.
- Secondary season: autumn, only when the main crop leaves it free.
- Requirements: owned irrigation; elevation index below 0.65.
- Stages: Continental relay lentils: trial plots → Continental relay lentils: seed nursery → Continental relay lentils: sowing equipment → Continental relay lentils: rotation station.

### Prairie pea strips

Early peas occupy small irrigated strips ahead of the late oilseed harvest.

- Crops: Sunflower fields.
- Climates: Prairie.
- Secondary season: summer, only when the main crop leaves it free.
- Requirements: owned irrigation.
- Stages: Prairie pea strips: trial plots → Prairie pea strips: seed nursery → Prairie pea strips: sowing equipment → Prairie pea strips: rotation station.

### Irrigated chickpea rotation

A limited chickpea crop follows cereal harvesting where irrigation bridges the dry summer.

- Crops: Golden fields, Barley fields, Alluvial wheat.
- Climates: Mediterranean, Subtropical.
- Secondary season: autumn, only when the main crop leaves it free.
- Requirements: owned irrigation.
- Stages: Irrigated chickpea rotation: trial plots → Irrigated chickpea rotation: seed nursery → Irrigated chickpea rotation: sowing equipment → Irrigated chickpea rotation: rotation station.
...
- Secondary season: spring, only when the main crop leaves it free.
- Requirements: elevation index below 0.72.
- Stages: Olive orchard broad beans: trial plots → Olive orchard broad beans: seed nursery → Olive orchard broad beans: sowing equipment → Olive orchard broad beans: rotation station.

### Rice and winter peas

Drained paddy margins carry cool-season peas after rice, harvested before the summer planting.

- Crops: Rice field, River rice.
- Climates: Subtropical.
- Secondary season: spring, only when the main crop leaves it free.
- Requirements: owned irrigation; owned drainage on wet/floodplain ground.
- Stages: Rice and winter peas: trial plots → Rice and winter peas: seed nursery → Rice and winter peas: sowing equipment → Rice and winter peas: rotation station.
...
- Secondary season: winter, only when the main crop leaves it free.
- Requirements: owned irrigation; owned drainage on wet/floodplain ground.
- Stages: Rice and mung beans: trial plots → Rice and mung beans: seed nursery → Rice and mung beans: sowing equipment → Rice and mung beans: rotation station.
...
- Climates: Monsoon.
- Secondary season: winter, only when the main crop leaves it free.
- Requirements: owned drainage on wet/floodplain ground; floodplain, delta, black earth or fertile-basin soil.
- Stages: Post-monsoon lentils: trial plots → Post-monsoon lentils: seed nursery → Post-monsoon lentils: sowing equipment → Post-monsoon lentils: rotation station.

### Alluvial wheat and sorghum

Irrigated sorghum follows the spring wheat harvest in warm, fertile river soils.

- Crops: Alluvial wheat.
- Climates: Desert, Hyperarid, Hot Semi-Arid.
- Secondary season: autumn, only when the main crop leaves it free.
- Requirements: owned irrigation; floodplain, delta, black earth or fertile-basin soil.
- Stages: Alluvial wheat and sorghum: trial plots → Alluvial wheat and sorghum: seed nursery → Alluvial wheat and sorghum: sowing equipment → Alluvial wheat and sorghum: rotation station.
...
- Secondary season: spring, only when the main crop leaves it free.
- Requirements: owned irrigation.
- Stages: Oasis understory beans: trial plots → Oasis understory beans: seed nursery → Oasis understory beans: sowing equipment → Oasis understory beans: rotation station.
...
- Crops: Millet fields.
- Climates: Hot Semi-Arid, Savanna.
- Secondary season: summer, only when the main crop leaves it free.
- Requirements: owned irrigation; elevation index below 0.65.
- Stages: Millet and cowpea strips: trial plots → Millet and cowpea strips: seed nursery → Millet and cowpea strips: sowing equipment → Millet and cowpea strips: rotation station.

### Savanna relay pulses

Fertile plots carry short-season pulses before the late sorghum harvest, supported by stored water.

- Crops: Sorghum fields, Recession sorghum.
- Climates: Savanna, Hot Semi-Arid.
- Secondary season: summer, only when the main crop leaves it free.
- Requirements: owned irrigation; floodplain, delta, black earth or fertile-basin soil.
- Stages: Savanna relay pulses: trial plots → Savanna relay pulses: seed nursery → Savanna relay pulses: sowing equipment → Savanna relay pulses: rotation station.
...
- Secondary season: summer, only when the main crop leaves it free.
- Requirements: floodplain, delta, black earth or fertile-basin soil; elevation index below 0.65.
- Stages: Maize relay beans: trial plots → Maize relay beans: seed nursery → Maize relay beans: sowing equipment → Maize relay beans: rotation station.
...
- Crops: Maize fields, Chinampa gardens.
- Climates: Mesoamerican.
- Secondary season: spring, only when the main crop leaves it free.
- Requirements: owned irrigation; owned drainage on wet/floodplain ground; elevation index below 0.52.
- Stages: Lowland maize and squash: trial plots → Lowland maize and squash: seed nursery → Lowland maize and squash: sowing equipment → Lowland maize and squash: rotation station.
