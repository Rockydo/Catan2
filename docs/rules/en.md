...
Only the strongest applicable owned weather protection counts. An 80% reduction of a 25% weather loss leaves a 5% loss; it is not an 80% yield bonus. Protections never stop river flooding or ice. Existing projects keep their owner and tier and immediately adopt the appropriate local method. Research sources and the full coefficient catalogue are in docs/local-production-methods.md; the amounts are game-balance values, not universal historical yields.
