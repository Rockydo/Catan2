...
### Soutien en Or contre un humain dominant

Avant chaque lancer de dés, comparez la puissance non arrondie de chaque faction humaine survivante à la puissance totale des factions survivantes. Si un humain détient plus de 40 %, chaque IA survivante reçoit 1 Or dans chacune de ses colonies et villes à ce lancer. Le montant passe à 2 à 45 %, 3 à 50 %, 4 à 55 %, puis augmente de 1 tous les cinq points de pourcentage. Exactement 40 % ne donne rien.
Chaque IA reçoit la totalité de son propre soutien. Une ville compte pour un site, quel que soit son niveau. Le soutien est versé sur les lancers humains comme sur ceux des IA, indépendamment du résultat, du climat, de la saison, du blocus ou du siège, et stocké dans l’agglomération concernée. Il ne produit aucun Lingot d’or. Le bilan de récolte inclut cet Or et indique la part du soutien ; le panneau des factions affiche le montant actuel.
Seule la puissance humaine peut déclencher cette règle. Plusieurs humains ne cumulent pas leur puissance et ne reçoivent jamais le soutien. Retenez la plus grande part individuelle humaine. Recalculez à chaque lancer : le soutien diminue avec cette part et cesse immédiatement à 40 % ou moins, indépendamment du seuil de 20 % libérant la coalition. La formule de puissance utilise la production normale, sans le soutien, afin que celui-ci ne modifie pas son propre seuil. Une ancienne sauvegarde applique la règle dès le prochain lancer, sans versement rétroactif.
