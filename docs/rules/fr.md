...
Une arête côtière entièrement révélée a 10 % de chances de devenir candidate pour un port. Un port exige de l’eau libre près d’une terre ferme : la banquise est exclue, mais les plaines enneigées conviennent. Les ports placés sur la banquise dans les anciennes sauvegardes sont supprimés au chargement. La moitié sont génériques à 3:1 ; l’autre moitié concerne une ressource brute à 2:1, sauf l’Or et l’Huile. Les ports ne partagent pas d’intersection. Une agglomération sur l’une des extrémités en bénéficie, sauf si elle est assiégée ou si la tuile maritime du port subit un blocus. Les anciens ports d’Or deviennent génériques au chargement.
